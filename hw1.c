...
int main(int argc, char* argv[]) {
	...
	if (strcmp(argv[1], "pointers") == 0) {
		...
		int numToReplace = atoi(argv[2]); //char * to int
		//printf("%d", numToReplace);
		int numElements = atoi(argv[3]);
		
		// STEP 6: Add a check to ensure user has passed correct num of args                           // w h a t???
